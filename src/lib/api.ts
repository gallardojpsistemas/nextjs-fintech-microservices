...
export const api = {
    ...
    payment: {
        ...
        tokenizeCard: (data: any) => fetchWrapper(`${PAYMENT_URL}/payment/card/tokenize`, { method: 'POST', body: JSON.stringify(data) }),
        getUserCards: (userId: string) => fetchWrapper(`${PAYMENT_URL}/payment/card/user/${userId}`),
        getUserCardPayments: (userId: string) => fetchWrapper(`${PAYMENT_URL}/payment/card/history/${userId}`),
